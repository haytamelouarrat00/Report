\documentclass[a4paper,10pt]{report} % Changed from 9pt (not valid) to 10pt
...
\usepackage{url}  % Added for URL support in bibliography

% --- No page numbering for title ---
\pagestyle{fancy}
\fancyhf{}
\setlength{\footskip}{57pt} % Increased from 50pt to avoid fancyhdr warning
\fancyfoot[C]{\thepage}
